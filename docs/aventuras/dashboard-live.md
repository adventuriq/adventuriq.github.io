...
- Si lo que quieres es conducir un **concurso en directo** dirigido por un moderador: [Modo Arena](../modo-arena/index.md).
- Cómo se unen los Players con el GamePIN o el QR: [Acceder a una Aventura](./acceder-a-una-aventura.md).
