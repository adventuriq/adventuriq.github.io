...
- Para editar una Recompensa existente, haz clic sobre su nombre.

## Contenido de una Recompensa

Una Recompensa se puede configurar con:
...
A nivel traducciones, funciona igual que cualquier caja de contenido multiidioma.

## Acciones

- **Guardar**: Guarda la configuración de la Recompensa.
- **Eliminar**: Elimina la Recompensa.
- **Atrás**: Devuelve al listado de Recompensas.
