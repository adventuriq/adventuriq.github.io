...
- La tienda de AdventuriQ permite comprar Licencias, Tokens y otros recursos.

## Información visible

En la configuración de la Aventura se muestra:
- Información sobre la **Licencia** de la Aventura.
- Número de **Tokens restantes** para todas las Aventuras.
