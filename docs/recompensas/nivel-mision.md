...
- **Vídeo** (MP4)
- **Audio** (MP3)
- **Código Único** para control de entregas analógicas

## Gestión

- Haz clic sobre el nombre de la Recompensa para editarla.
- Usa los botones para crear, guardar o eliminar Recompensas.
